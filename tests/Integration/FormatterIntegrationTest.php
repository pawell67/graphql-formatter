...
class FormatterIntegrationTest extends TestCase
{
    ...
    public function test_simple_query_fixture(): void { $this->assertFixture('simple-query.gql'); }
    public function test_simple_query_idempotent(): void { $this->assertFixtureIdempotent('simple-query.gql'); }
    public function test_inline_args_fixture(): void { $this->assertFixture('inline-args.gql'); }
    public function test_multiline_args_fixture(): void { $this->assertFixture('multiline-args.gql'); }
    public function test_fragment_fixture(): void { $this->assertFixture('fragment.gql'); }
    public function test_imports_fixture(): void { $this->assertFixture('imports.gql'); }
    public function test_nested_objects_fixture(): void { $this->assertFixture('nested-objects.gql'); }
    public function test_inline_fragments_fixture(): void { $this->assertFixture('inline-fragments.gql'); }
    public function test_complex_fixture(): void { $this->assertFixture('complex.gql'); }
    public function test_complex_idempotent(): void { $this->assertFixtureIdempotent('complex.gql'); }
